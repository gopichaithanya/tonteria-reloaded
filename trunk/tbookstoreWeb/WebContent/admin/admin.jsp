...
<form action="/tbookstoreWeb/customers" method="get">
...
<form action="/tbookstoreWeb/books" method="post" enctype='multipart/form-data'
>
...
description: <textarea name="description" rows="5" cols="30">descrizione</textarea>
